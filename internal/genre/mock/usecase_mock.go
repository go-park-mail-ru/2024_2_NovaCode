...
import (
	...
	dto "github.com/go-park-mail-ru/2024_2_NovaCode/internal/genre/dto"
...
func (m *MockUsecase) GetAllByAlbumID(ctx context.Context, albumID uint64) ([]*dto.GenreDTO, error) {
	m.ctrl.T.Helper()
