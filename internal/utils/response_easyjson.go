...
func easyjson6ff3ac1dDecodeGithubComGoParkMailRu20242NovaCodeInternalUtils1(in *jlexer.Lexer, out *ErrorResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6ff3ac1dEncodeGithubComGoParkMailRu20242NovaCodeInternalUtils1(out *jwriter.Writer, in ErrorResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6ff3ac1dDecodeGithubComGoParkMailRu20242NovaCodeInternalUtils2(in *jlexer.Lexer, out *CSRFResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6ff3ac1dEncodeGithubComGoParkMailRu20242NovaCodeInternalUtils2(out *jwriter.Writer, in CSRFResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
