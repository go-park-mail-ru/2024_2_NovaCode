...
func RegisterArtistService(cfg *config.AuthConfig, usecase artist.Usecase, logger logger.Logger) func(server *grpc.Server) {
	return func(server *grpc.Server) {
		artistsServer := NewArtistsService(cfg, usecase, logger)
