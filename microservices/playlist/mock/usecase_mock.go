...
//
//	mockgen -source=microservices/playlist/usecase.go -destination=microservices/playlist/mock/usecase_mock.go package=mock
//
...
func (mr *MockUsecaseMockRecorder) AddFavoritePlaylist(ctx, userID, playlistID any) *gomock.Call {
...
func (mr *MockUsecaseMockRecorder) AddToPlaylist(ctx, playlistTrackDTO any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) CreatePlaylist(ctx, newPlaylistDTO any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) DeleteFavoritePlaylist(ctx, userID, playlistID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) DeletePlaylist(ctx, playlistID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetAllPlaylists(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetFavoritePlaylists(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUsecase) GetFavoritePlaylistsCount(ctx context.Context, userID uuid.UUID) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetFavoritePlaylistsCount(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFavoritePlaylistsCount", reflect.TypeOf((*MockUsecase)(nil).GetFavoritePlaylistsCount), ctx, userID)
}
...
func (mr *MockUsecaseMockRecorder) GetPlaylist(ctx, playlistID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUsecase) GetPlaylistLikesCount(ctx context.Context, playlistID uint64) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetPlaylistLikesCount(ctx, playlistID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetPopularPlaylists(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetUserPlaylists(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) IsFavoritePlaylist(ctx, userID, playlistID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) RemoveFromPlaylist(ctx, playlistTrackDTO any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUsecase) Update(ctx context.Context, playlist *models.Playlist) (*dto.PlaylistDTO, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) Update(ctx, playlist any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockUsecase)(nil).Update), ctx, playlist)
}

// UploadImage mocks base method.
func (m *MockUsecase) UploadImage(ctx context.Context, playlistID uint64, file s3.Upload) (*dto.PlaylistDTO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadImage", ctx, playlistID, file)
	ret0, _ := ret[0].(*dto.PlaylistDTO)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUsecaseMockRecorder) UploadImage(ctx, playlistID, file any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadImage", reflect.TypeOf((*MockUsecase)(nil).UploadImage), ctx, playlistID, file)
}
