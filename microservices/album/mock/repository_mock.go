...
//
//	mockgen -source=microservicesalbum/repository.go -destination=microservices/album/mock/repository_mock.go -package=mock
//
...
func (mr *MockRepoMockRecorder) Create(ctx, album any) *gomock.Call {
...
func (mr *MockRepoMockRecorder) FindById(ctx, albumID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
