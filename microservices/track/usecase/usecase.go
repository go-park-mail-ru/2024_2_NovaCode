...
func NewTrackUsecase(
	...
	return &trackUsecase{trackRepo, albumClient, artistClient, logger}
}
...
// func NewTrackUsecase(trackRepo track.Repo, logger logger.Logger) track.Usecase {
// 	return &trackUsecase{trackRepo, logger}
// }
