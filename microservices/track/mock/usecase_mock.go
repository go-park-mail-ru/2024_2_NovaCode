...
func (m *MockUsecase) GetFavoriteTracksCount(ctx context.Context, userID uuid.UUID) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUsecaseMockRecorder) GetFavoriteTracksCount(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFavoriteTracksCount", reflect.TypeOf((*MockUsecase)(nil).GetFavoriteTracksCount), ctx, userID)
}
